...
import image03 from "../../../../assets/ServicesSection/image-03.jpg";
import { BsCheck } from "react-icons/bs";

const PartsRepairingSection = () => {
  return (
    <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-14">
      <div className="w-full">
        <img src={image03} className="w-full object-cover" alt="/" />
      </div>
      <div>
        <h2 className="text-secondary text-2xl font-bold">Parts Repairing</h2>
        <p className="my-5">
...
export default PartsRepairingSection;
